...
function ProductDetails() {
  ...
  const { data: details, isFetching, isLoading } = useGetSpecificProductQuery(`${params.productId}`, {
    refetchOnMountOrArgChange: true,
  });

  if (isFetching || isLoading || !details) {
  ...
  return (
    <div>
      <div className="inline">
        <ImageViewer styles={styles.results[0]} />
        <Details details={details} styles={styles} />
      </div>
