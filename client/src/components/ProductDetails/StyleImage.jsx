  ...
  return (
    <div className="flex circleDiv">
      <button className="buttonWrap circle-btn" onClick={handleClick} type="button" aria-label="style-image">
        ...
        <img className={current ? 'selected' : 'circleImage'} src={image || 'https://images.unsplash.com/photo-1584824486509-112e4181ff6b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8bm90JTIwZm91bmR8ZW58MHx8MHx8&auto=format&fit=crop&w=400&q=60'} alt="ImageView" height="60" width="auto" />
      </button>
    </div>
  );
}
